...
* There seems to be some date-fns bug that leads to an infinite loop in hourly-based simulation data aggregation when the DST switch day of October is hit.
